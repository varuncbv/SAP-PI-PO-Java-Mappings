...
public class AddExcelNamespace_Main {
 ...
 try {
				...
				**/
					...
					"<Cell><Data ss:Type=\"String\">TOTAL_COST_GST</Data></Cell>"+
					"</Row>";
					...
					File inputFile=new File("C:\\JTI\\JTI_Message_Mapping_output.xml");
					...
					System.out.println("OrdersList.length"+OrdersList.getLength());
